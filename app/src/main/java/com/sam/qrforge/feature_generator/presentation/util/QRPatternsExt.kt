...
private fun QRUIModel.isNotFinderPatternOrMargin(posX: Int, posY: Int): Boolean {
...
fun QRUIModel.finderOffsets(blockSize: Float): List<Offset> {
	return buildList {
...
fun QRUIModel.timingPatternOffsets(blockSize: Float): List<Offset> {
	return buildList {
		// width line
...
fun QRUIModel.alignmentPatternOffsets(blockSize: Float): List<Offset> {
...
fun QRUIModel.dataBitsOffset(blockSize: Float): List<Offset> {
	return buildList {
